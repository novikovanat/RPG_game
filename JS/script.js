...
const locations = [
  {
    name: 'town square',
    'button text': ['Go to a store', 'Go to cave', 'Fight dragon'],
  ...
  {
    name: 'kill monster',
    'button text': ['Go to town square', 'Go to town square', 'Go to a store'],
    'button functions': [goTown, easterEgg, goStore],
